...
import { ClipboardCopy, Download, Ellipsis, Link, MoveDiagonal } from 'lucide-react';
...
const ActionItems: Array<{
  ...
  { key: 'onCopyLink', icon: <Link className="size-4" />, tooltip: 'Copy image link', isLink: true }
]

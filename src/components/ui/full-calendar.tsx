...
const CalendarMonthView = () => {
  ...
  return (
      ...
      <div className="grid grid-cols-7 pb-2 items-center sticky top-0 border-b">
        {weekDays.map((day, i) => (
          <div
            key={day}
            className={cn(
...
const CalendarCurrentDate = () => {
  ...
  return (
    <time suppressHydrationWarning dateTime={date.toISOString()} className="tabular-nums text-sm">
